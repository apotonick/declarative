...
class DefaultsOptionsTest < Minitest::Spec
  ...
  describe "deprecation" do
    ...
    it "prints deprecation twice" do
      ...
      _($stderr.string).must_equal %{[Declarative] Defaults#merge! and #call still accept arrays and automatically prepend those. This is now deprecated, you should replace `ary` with `Declarative::Variables::Append(ary)`.\n}*2
    end
  end
end
